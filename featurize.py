...
def freq_for_feature(text, freq):
    return float(freq['for'])
def freq_to_feature(text, freq):
    return float(freq['to'])
...
def generate_feature_vector(text, freq):
    ...
    feature.append(freq_thank_feature(text, freq))
    ...
    feature.append(freq_with_feature(text, freq))
    feature.append(freq_please_feature(text, freq))
    feature.append(freq_let_feature(text, freq))
    feature.append(freq_me_feature(text, freq))
    feature.append(freq_need_feature(text, freq))
    feature.append(freq_http_feature(text, freq))
    feature.append(freq_https_feature(text, freq))
    feature.append(freq_com_feature(text, freq))
    feature.append(freq_dotcom_feature(text, freq))
    ...
    feature.append(freq_doubleSlash_feature(text, freq))
    feature.append(freq_questionMark_feature(text, freq))
    feature.append(freq_equal_feature(text, freq))
    feature.append(freq_dash_feature(text, freq))
    feature.append(freq_count_feature(text, freq))
